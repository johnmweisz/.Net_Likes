    ...
    public class LogRegController : Controller
    {
        ...
        public IActionResult Register(LogReg LogReg)
        {
            if(ModelState.IsValid)
            {
                ...
                if(db.Users.Any(u => u.Email == LogReg.Register.Email))
                {
                ...
                db.Add(LogReg.Register);
                db.SaveChanges();
                // Save ID to Session.
                User GetID = db.Users.FirstOrDefault(u => u.Email == LogReg.Register.Email);
        ...
        public IActionResult Login(LogReg LogReg)
        {
            if(ModelState.IsValid)
            {
                ...
                User FindUserById = db.Users.FirstOrDefault(u => u.Email == LogReg.Login.Email);
                ...
                // Convert string to hash and compare against hashed hassword in the db.
